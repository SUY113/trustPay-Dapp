    ...
    <div className="Staff-container">
      <header className="Staff-header">
        ...
        >
          ...
          <p>
            <strong>Tên người yêu cầu nhận:</strong> {nameInfo}
          </p>
          <p>
            <strong>Tổ chức người yêu cầu nhận:</strong> {orgInfo}
          </p>
          <p>
            <strong>Địa chỉ người yêu cầu:</strong> {clientAccountID}
          </p>
          <button
            type="button"
            onClick={() => {
        ...
        >
          ...
          <p>
            <strong>Tên người yêu cau ung tien:</strong> {nameInfo}
          </p>
          <p>
            <strong>Tổ chức người yêu cầu ung tien</strong> {orgInfo}
          </p>
          <p>
            <strong>Địa chỉ người yêu cầu ung tien:</strong> {clientAccountID}
          </p>
          <label>
            So tien muon ung
            <input
          ...
          <button type="button" onClick={() => setIsAdvancePaymentOpen(false)}>
            Đóng
          </button>
        </Modal>
      </header>
