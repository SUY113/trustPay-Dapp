...
function DashboardStaff() {
  ...
  const handleTransferTokenClick = () => {
    if (userInfo) {
      ...
      setErrorMessage(
        "Vui lòng truy vấn thông tin người dùng trước khi chuyển."
      );
    }
  };
  ...
  return (
    <div className="dashboard-container">
      ...
      >
        ...
        <p>
          <strong>Ten nguoi doi:</strong> {userInfo ? userInfo.name : ""}
        </p>
        <p>
          <strong>To chuc thuoc ve:</strong> {userInfo ? userInfo.org : ""}
        </p>
